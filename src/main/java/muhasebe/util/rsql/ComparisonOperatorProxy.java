...
public enum ComparisonOperatorProxy {
	...
	/*
	 *Temel olarak string query içinde kullanılacak operasyonları tutan enum yapısıdır.
	 *burdaki opersayonlar üzerinden işlemler yapılacaktır. 
	 * */
